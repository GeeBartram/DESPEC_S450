...
void EventCorrelProc::Make_FRS_Prompt_Ge_Histos(){
  ...
  if(fCorrel->GSetup_corr_FRS_Gamma_Gamma==1){
      hA_Ge_Gamma_Gamma_all= MakeTH2('D',"Correlations/FRS-Prompt_Ge/Ge_Gamma_Gamma_all","Gamma-Gamma", fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,"Ge1 Energy (keV)","Ge2 Energy (keV)" );
  }
  ...
  for(int i=0; i<MAX_FRS_GATE; i++){
    ...
    //X4AoQ
    hA_FRS_X4AoQ_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/X4AoQ_Ge/SinglesEnergy/Ge_Energy_X4AoQGate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_X4AoQ_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/X4AoQ_Ge/GeE_vs_dT/GeE_vs_FRSGe_dT_X4AoQGate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");

    if(fCorrel->GSetup_corr_FRS_Gamma_Gamma==1){
      hA_FRS_X4AoQ_GeE1_GeE2[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/X4AoQ_Ge/Gamma-Gamma/GeE1_vs_GeE2_X4AoQ_Gate%d",i),Form("Gamma-Gamma X4AoQ_Ge Gated: %d",i), fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,  fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "Ge Energy1 (keV)", "Ge Energy2 (keV)");
    }


    //dEvsZ_zero X4AoQ
    hA_FRS_dEvsZ_X4AoQ_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/zero/SinglesEnergy/Ge_Energy_dEvsZ_X4AoQGate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/zero/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_X4AoQGate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");

    if(fCorrel->GSetup_corr_FRS_Gamma_Gamma==1){
      hA_FRS_dEvsZ_X4AoQ_GeE1_GeE2[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/zero/Gamma-Gamma/GeE1_vs_GeE2_dEvsZ_X4AoQ_Gate%d",i),Form("Gamma-Gamma X4AoQ_Ge Gated: %d",i), fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,  fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "Ge Energy1 (keV)", "Ge Energy2 (keV)");
    }

    //dEvsZ_zero X4AoQ Z1Z2 Gated
    hA_FRS_dEvsZ_X4AoQ_Z1Z2_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/zero/Z1Z2_gated/SinglesEnergy/Ge_Energy_dEvsZ_Z1Z2_X4AoQGate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_Z1Z2_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/zero/Z1Z2_gated/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_Z1Z2_X4AoQGate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");


    //dEvsZp1 X4AoQ
    hA_FRS_dEvsZ_X4AoQ_p1_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/p1/SinglesEnergy/Ge_Energy_dEvsZ_X4AoQ_p1Gate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_p1_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/p1/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_X4AoQ_p1Gate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");

    if(fCorrel->GSetup_corr_FRS_Gamma_Gamma==1){
      hA_FRS_dEvsZ_X4AoQ_p1_GeE1_GeE2[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/p1/Gamma-Gamma/GeE1_vs_GeE2_dEvsZ_X4AoQ_p1Gate%d",i),Form("Gamma-Gamma X4AoQ_Ge Gated: %d",i), fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,  fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "Ge Energy1 (keV)", "Ge Energy2 (keV)");
    }

    //dEvsZp1 X4AoQ Z1Z2 Gated
    hA_FRS_dEvsZ_X4AoQ_Z1Z2_p1_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/p1/Z1Z2_gated/SinglesEnergy/Ge_Energy_dEvsZ_X4AoQ_Z1Z2_p1Gate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_Z1Z2_p1_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/p1/Z1Z2_gated/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_X4AoQ_Z1Z2_p1Gate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");

    //dEvsZm1 X4AoQ
    hA_FRS_dEvsZ_X4AoQ_m1_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/m1/SinglesEnergy/Ge_Energy_dEvsZ_X4AoQ_m1Gate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_m1_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/m1/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_X4AoQ_m1Gate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");

    if(fCorrel->GSetup_corr_FRS_Gamma_Gamma==1){
      hA_FRS_dEvsZ_X4AoQ_m1_GeE1_GeE2[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/m1/Gamma-Gamma/GeE1_vs_GeE2_dEvsZ_X4AoQ_m1_Gate%d",i),Form("Gamma-Gamma X4AoQ_Ge Gated: %d",i), fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,  fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "Ge Energy1 (keV)", "Ge Energy2 (keV)");
    }

    //dEvsZm1 X4AoQ Z1Z2 Gated
    hA_FRS_dEvsZ_X4AoQ_Z1Z2_m1_GeE[i]  = MakeTH1('F', Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/m1/Z1Z2_gated/SinglesEnergy/Ge_Energy_dEvsZ_X4AoQ_Z1Z2_m1Gate%d", i), Form("Germanium Energy FRS X4AoQ Gate %d", i), 2000, 0, 2000, "Energy/keV");

    hA_FRS_dEvsZ_X4AoQ_Z1Z2_m1_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/dEvsZ_X4AoQ_Ge/m1/Z1Z2_gated/GeE_vs_dT/GeE_vs_FRSGe_dT_dEvsZ_X4AoQ_Z1Z2_m1Gate%d",i),Form("T Diff FRS - Ge vs Ge Energy X4AoQ Gate %d",i),  2100,-1000,20000,2000, 0, 2000,"SCI41 - Ge time (ns)", "Ge Energy (keV)");
...
void EventCorrelProc::Process_FRS_Prompt_Ge(EventAnlStore* cInputMain, EventCorrelStore* cOutput){
  ...
  for(int g=0; g<Germanium_MAX_DETS; g++){
    for(int h=0; h<Germanium_CRYSTALS; h++){
      ...
      //hA_Ge_Gamma_Gamma_all->Fill(); GEEBART
	  }
  }
        ...
        if(dT_frsge_prompt>fCorrel->GFRS_Ge_TLow && dT_frsge_prompt < fCorrel->GFRS_Ge_THigh &&cInputMain->pGe_E[g][h]>1){
          ...
          //if((cInputMain->pGe_T[g][h] - cInputMain->pGe_T[Germanium_SC41_Det][Germanium_SC41L_Crystal])>fCorrel->GGe_SCI41_Low && (cInputMain->pGe_T[g][h] - cInputMain->pGe_T[Germanium_SC41_Det][Germanium_SC41L_Crystal])<fCorrel->GGe_SCI41_High){
            ...
            if(cInputMain->pGe_T_Aligned[g][h]>0 && cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]>0){
              ...
              // X4 AoQ gated
              if(cInputMain->pFRS_x4AoQ_pass[gate]==true){
                hA_FRS_X4AoQ_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                hA_FRS_X4AoQ_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
              }


              //dEvsZ X4AoQ deltaQ=0
              if(cInputMain->pFRS_dEvsZ_x4AoQ_pass[gate]==true){
                  hA_FRS_dEvsZ_X4AoQ_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                  hA_FRS_dEvsZ_X4AoQ_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);

                  if(cInputMain->pFRS_Z_Z2_pass[gate]==true){
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
                  }
              }
              

              //dEvsZ X4AoQ deltaQ=+1
              if(cInputMain->pFRS_dEvsZ_x4AoQ_p1_pass[gate]==true){
                  hA_FRS_dEvsZ_X4AoQ_p1_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                  hA_FRS_dEvsZ_X4AoQ_p1_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
                  if(cInputMain->pFRS_Z_Z2_pass[gate]==true){
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_p1_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_p1_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
                  }                  
              }
              

              //dEvsZ X4AoQ deltaQ=-1
              if(cInputMain->pFRS_dEvsZ_x4AoQ_m1_pass[gate]==true){
                  hA_FRS_dEvsZ_X4AoQ_m1_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                  hA_FRS_dEvsZ_X4AoQ_m1_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
                  if(cInputMain->pFRS_Z_Z2_pass[gate]==true){
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_m1_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                    hA_FRS_dEvsZ_X4AoQ_Z1Z2_m1_GeEvsT[gate]->Fill((cInputMain->pGe_T_Aligned[g][h] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_E[g][h]);
                  }             
              }
        ...
        for(int n=0; n<Ge_mult_prompt; n++){
          ...
          if((GeT_Prm[m]-GeT_Prm[n])>fCorrel->GGe1_Ge2_Low && (GeT_Prm[m]-GeT_Prm[n])<fCorrel->GGe1_Ge2_High){
            if(cGe_EdT_cut[gate]->Test(GeT_Prm[m] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi],GeE_Prm[m])==true && cGe_EdT_cut[gate]->Test(GeT_Prm[n] - cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi],GeE_Prm[n])==true){
              ...
              if(cInputMain->pFRS_x4AoQ_pass[gate]==true )    hA_FRS_X4AoQ_GeE1_GeE2[gate]->Fill(GeE_Prm[m],GeE_Prm[n]);
              if(cInputMain->pFRS_dEvsZ_x4AoQ_pass[gate]==true )    hA_FRS_dEvsZ_X4AoQ_GeE1_GeE2[gate]->Fill(GeE_Prm[m],GeE_Prm[n]);
              if(cInputMain->pFRS_dEvsZ_x4AoQ_p1_pass[gate]==true )    hA_FRS_dEvsZ_X4AoQ_p1_GeE1_GeE2[gate]->Fill(GeE_Prm[m],GeE_Prm[n]);
              if(cInputMain->pFRS_dEvsZ_x4AoQ_m1_pass[gate]==true )    hA_FRS_dEvsZ_X4AoQ_m1_GeE1_GeE2[gate]->Fill(GeE_Prm[m],GeE_Prm[n]);
            }///Z1 Z2
          }///prompt cut
    ...
    for(auto& i : imphits){
      ...
      if(imphit.DSSD<=2 && imphit.Stopped){
        ...
        for(int gate=0;gate<MAX_FRS_GATE;gate++){
          ...
          if(fCorrel->GBDG_FRS_Gate==2 && cInputMain->pFRS_Z_Z2_pass[0]==true && cInputMain->pFRS_x2AoQ_pass[gate]==true ){
            jPID.GatePass = gate;
          }
          if(fCorrel->GBDG_FRS_Gate==3 && cInputMain->pFRS_x4AoQ_pass[gate]==true){
            jPID.GatePass = gate;
          }
        }
