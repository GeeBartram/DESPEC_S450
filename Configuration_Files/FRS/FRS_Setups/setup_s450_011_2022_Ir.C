...
void setup_s450_011_2022()
{
 ...
 /*
  ...
  frs->bfield[2] = 9.5671;//202Os //  Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. preparing for S450
  frs->bfield[3] = 9.5671;//202Os //  Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. preparing for S450
...
//  id->mhtdc_offset_z_sc22=0.0;
  ...
  //not related for S8
  id->offset_z   = -0.7044; //run75
  id->offset_z2  = -0.7868; //run75
  id->offset_z3  = 0.0;
