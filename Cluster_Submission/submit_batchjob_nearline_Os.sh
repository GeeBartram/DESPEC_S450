...
echo "z2shift: $z2shift"
 ...
 #GERMANIUM CALIBRATION
  ...
  cp ../Configuration_Files/2D_Gates/ID_dEvsZ_Os.txt ../Configuration_Files/2D_Gates/ID_dEvsZ.txt
...
void setup_s450_011_2022()
{
 ...
 /*
  ...
  id->x_s2_select   = 1; //1=tpc,2=sc21,3=sc22 GEE  TEMPORAILITY CHANGED TO SCI
