...
FILE="/lustre/gamma/gbartram/DESPEC_S450_NEARLINE/Cluster_Submission/Include_Runs_calum.txt"
DATA_PATH=/lustre/gamma/DESPEC_S452_FILES/newts
...
#LIST FILE
ls $DATA_PATH/S452f103_0037* > /lustre/gamma/gbartram/DESPEC_S450_NEARLINE/Cluster_Submission/List_Files/files_${RUN}.txt
...
//not related for S8
  id->offset_z   = 0.0; //run75
  id->offset_z2  = 0.0; //run75
  id->offset_z3  = 0.0;
